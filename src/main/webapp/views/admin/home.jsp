    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Bảng thống kế tình hình bán hàng</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header border-0">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title">Số lương ghé thăm trang web</h3>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <p class="d-flex flex-column">
                                        ...
                                        <span>Số lượng  truy cập theo thời gian</span>
                                    </p>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <p class="d-flex flex-column">
                                        <span class="text-bold text-lg">18.230.000đ</span>
                  ...
                  <span class="mr-2">
                    ...
                    <i class="fas fa-square text-gray"></i> Năm trước
                        ...
                        <div class="card">
                            <div class="card-header border-0">
                                <h3 class="card-title">Tổng quan cửa hàng trực tuyến</h3>
                                <div class="card-tools">
